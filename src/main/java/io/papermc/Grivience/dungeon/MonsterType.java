...
public enum MonsterType {
    ...
    SHOGUN_ELITE("Shogun Elite", EntityType.PIGLIN_BRUTE, NamedTextColor.GOLD, 2.2D, 1.75D, 1),
    TEMPLE_GUARDIAN("Temple Guardian", EntityType.IRON_GOLEM, NamedTextColor.DARK_GRAY, 3.5D, 1.9D, 0);
    ...
    public void applyLoadout(LivingEntity living, int damageTier) {
        ...
        switch (this) {
            case ONI_BRUTE -> {
                ...
                equipment.setChestplate(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.IRON_CHESTPLATE)));
            }
            case TENGU_SKIRMISHER -> {
                ...
                equipment.setHelmet(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.CHAINMAIL_HELMET)));
            }
            case KAPPA_RAIDER -> {
            ...
            case KITSUNE_TRICKSTER -> {
                ...
                equipment.setHelmet(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.GOLDEN_HELMET)));
            }
            case GASHADOKURO_SENTINEL -> {
                ...
                equipment.setHelmet(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.NETHERITE_HELMET)));
                equipment.setChestplate(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.NETHERITE_CHESTPLATE)));
            }
            case SHOGUN_ELITE -> {
                ItemStack heavyAxe = new ItemStack(Material.NETHERITE_AXE);
                heavyAxe.addUnsafeEnchantment(Enchantment.SHARPNESS, Math.max(3, 3 + (damageTier / 2)));
                equipment.setItemInMainHand(heavyAxe);
                equipment.setHelmet(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.NETHERITE_HELMET)));
                equipment.setChestplate(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.NETHERITE_CHESTPLATE)));
                equipment.setLeggings(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.NETHERITE_LEGGINGS)));
                equipment.setBoots(ArmorDurabilityUtil.ensureArmorUnbreakable(new ItemStack(Material.NETHERITE_BOOTS)));
            }
            case TEMPLE_GUARDIAN -> {
                // Iron Golems do not use equipment.
            }
        }
    }
    ...
    public void applySpecialEffects(LivingEntity living, int damageTier) {
        ...
        switch (this) {
            ...
            case TEMPLE_GUARDIAN -> {
                living.addPotionEffect(new PotionEffect(PotionEffectType.RESISTANCE, Integer.MAX_VALUE, 3, false, false));
    ...
    public static List<MonsterType> defaultPool() {
        return List.of(
                ONI_BRUTE,
                TENGU_SKIRMISHER,
                KAPPA_RAIDER,
    ...
    public static List<MonsterType> strongerPool() {
        List<MonsterType> pool = new ArrayList<>(defaultPool());
        pool.add(GASHADOKURO_SENTINEL);
        pool.add(SHOGUN_ELITE);
        pool.add(TEMPLE_GUARDIAN);
        return pool;
    }

    public static MonsterType parse(String input) {
